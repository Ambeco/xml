...
namespace mpd {
	namespace xml {
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<std::string>& attribute, const std::string& found_attribute, std::string&& value)
		{
		...
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<char>& att, const std::string& found_attribute, std::string&& value) 
		{ return try_read_int_attribute_helper<long, std::strtol>(reader, desired_attribute, att, found_attribute, std::move(value)); }
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<signed char>& att, const std::string& found_attribute, std::string&& value)
		{ return try_read_int_attribute_helper<long, std::strtol>(reader, desired_attribute, att, found_attribute, std::move(value)); }
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<short>& att, const std::string& found_attribute, std::string&& value)
		{ return try_read_int_attribute_helper<long, std::strtol>(reader, desired_attribute, att, found_attribute, std::move(value)); }
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<int>& att, const std::string& found_attribute, std::string&& value)
		{ return try_read_int_attribute_helper<long, std::strtol>(reader, desired_attribute, att, found_attribute, std::move(value)); }
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<long>& att, const std::string& found_attribute, std::string&& value)
		{ return try_read_int_attribute_helper<long, std::strtol>(reader, desired_attribute, att, found_attribute, std::move(value)); }
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<long long>& att, const std::string& found_attribute, std::string&& value)
		{ return try_read_int_attribute_helper<long long, std::strtoll>(reader, desired_attribute, att, found_attribute, std::move(value)); }

		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<unsigned char>& att, const std::string& found_attribute, std::string&& value)
		...
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<unsigned short>& att, const std::string& found_attribute, std::string&& value)
		{ return try_read_int_attribute_helper<unsigned long, std::strtoul>(reader, desired_attribute, att, found_attribute, std::move(value)); }
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<unsigned int>& att, const std::string& found_attribute, std::string&& value)
		{ return try_read_int_attribute_helper<unsigned long, std::strtoul>(reader, desired_attribute, att, found_attribute, std::move(value)); }
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<unsigned long>& att, const std::string& found_attribute, std::string&& value)
		{ return try_read_int_attribute_helper<unsigned long, std::strtoul>(reader, desired_attribute, att, found_attribute, std::move(value)); }
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<unsigned long long>& att, const std::string& found_attribute, std::string&& value)
		...
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<float>& att, const std::string& found_attribute, std::string&& value)
		{ return try_read_float_attribute_helper<float, std::strtof>(reader, desired_attribute, att, found_attribute, std::move(value)); }
		bool try_read_attribute(attribute_reader& reader, const char* desired_attribute, std::optional<double>& att, const std::string& found_attribute, std::string&& value)
